...
def decompress_huffman(source_dir, target_path, model_parameters=None):
...
if __name__ == '__main__':
    decompress_arithmatic(f"D:\\asaf\\יב\\compression learning\\data and stuff\\test data\\compressed_bible_2", f"D:\\asaf\\יב\\compression learning\\data and stuff\\test data\\decompressed_bible.txt")
